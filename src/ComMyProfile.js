...
function ComMyProfile() {
    ...
    const handleTabChange = (tab) => {
        setActiveTab(tab);
        setShowPersonalDetails(tab === 'Personal Details');
        setShowManageAddresses(tab === 'Manage Addresses');
        setShowPanCard(tab === 'PAN Card Information');
        setShowSavedUPI(tab === 'Saved UPI');
        setShowSavedCards(tab === 'Saved Cards');
    };
            ...
            <div style={{
                ...
                <aside style={{
                    ...
                    <div style={{
                        ...
                        <div>
                            <p style={{ margin: 0, fontSize: "12px", color: "#666", fontWeight: "bold" }}>Hello,</p>
                            <p style={{ margin: 0, fontWeight: "bold", color: "#184872", fontFamily: "momo trust display" }}>
                                {firstName} {lastName}
                            </p>
                        </div>
                    </div>
                    ...
                    {[
                        ...
                        <button
                            ...
                            style={{
                                ...
                                color: activeTab === tab.id ? "#184872" : "#555",
                                borderRadius: "8px",
                                cursor: "pointer",
                                width: "100%",
                                textAlign: "left",
                            ...
                            <div style={{
                                ...
                                <div style={{ marginBottom: "30px", borderBottom: "1px solid #eee", paddingBottom: "20px" }}>
                                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "15px" }}>
                                        <h4 style={{ color: "#333", fontSize: "1.2rem", fontWeight: "bold", fontFamily: "momo trust display" }}>Full Name</h4>
                                        <button
                                            onClick={() => setIsEditingNames(!isEditingNames)}
                                            style={{ color: "#2874f0", border: "none", background: "none", cursor: "pointer", fontWeight: "bold", fontSize: "14px" }}
                                        >
                                            {isEditingNames ? "Cancel" : "Edit"}
                                        </button>
                                    </div>
                                    {isEditingNames ? (
                                        <div style={{ display: "flex", gap: "15px" }}>
                                            ...
                                            <button
                                                ...
                                                style={{ background: "#2874f0", color: "white", padding: "10px 20px", borderRadius: "6px", border: "none", cursor: "pointer", fontWeight: "bold" }}
                                            >
                                                Save
                                            </button>
                                        </div>
                                    ) : (
                                        <p style={{ fontSize: "1.1rem", color: "#555" }}>{firstName} {lastName}</p>
                                    )}
                                </div>
                                ...
                                <div style={{ marginBottom: "30px", borderBottom: "1px solid #eee", paddingBottom: "20px" }}>
                                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "15px" }}>
                                        <h4 style={{ color: "#333", fontSize: "1.2rem", fontWeight: "bold", fontFamily: "momo trust display" }}>Email Address</h4>
                                        <button
                                    ...
                                    {isEditingEmail ? (
                                        ...
                                        <p style={{ fontSize: "1.1rem", color: "#555" }}>{email}</p>
                                    )}
                                </div>
                                ...
                                <div style={{ marginBottom: "0" }}>
                                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "15px" }}>
                                        <h4 style={{ color: "#333", fontSize: "1.2rem", fontWeight: "bold", fontFamily: "momo trust display" }}>Mobile Number</h4>
                                        <button
                                    ...
                                    {isEditingPhone ? (
                                        ...
                                        <p style={{ fontSize: "1.1rem", color: "#555" }}>{phone}</p>
                                    )}
                                </div>
                            </div>
                        )}
                        ...
                        {showPanCard && (
                            ...
                            >
                                ...
                                <div style={{ marginBottom: "25px", textAlign: "center" }}>
                                    <p style={{ color: "#666", fontSize: "1.1rem", marginBottom: "20px", fontFamily: "momo trust display" }}>
                                        Secure your account and transactions by providing your PAN details.
                                    </p>
                                </div>

                                <div style={{ display: "flex", flexDirection: "column", gap: "20px", marginBottom: "25px" }}>
                                    <div style={{ width: "100%" }}>
                                        <label style={{ display: "block", marginBottom: "8px", fontWeight: "bold", color: "#333", fontFamily: "momo trust display" }}>
                                            PAN Card Number
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div style={{ width: "100%" }}>
                                        ...
                                        <div style={{
                                            ...
                                            textAlign: "center",
                                            cursor: "pointer",
                                            background: panFile ? "rgba(102, 126, 234, 0.05)" : "transparent"
                                        }}>
                                            <input
                                                type="file"
                                                accept="image/*"
                                            ...
                                            <p style={{ margin: 0, color: "#667eea", fontWeight: "bold" }}>
                                                {panFile ? panFile.name : "Click or drag to upload image"}
                                            </p>
                                        </div>
                                    </div>
                                    {panFile && (
                                        <p style={{ color: "#28a745", fontSize: "0.9rem", marginTop: "-15px", fontWeight: "bold", fontFamily: "momo trust display" }}>
