    ...
    return (
        <div
            style={{
                ...
                height: "100dvh",
                overflowY: "auto",
                background: `url(${SELL_BG_URL}) center center / cover no-repeat fixed`,
        ...
        >
                    ...
                    {!isAuthenticated ? (
                        <>
                            <button
                                ...
                                onClick={() => setShowLoginFormPopup(true)} // Open login popup
            ...
            <div style={{
                ...
                {/* Content section */}
                <div className="sell-outer-container" style={{
                    flex: "1",
                    display: "flex",
                    justifyContent: "center",
                    alignItems: "center",
            ...
            {showFullSignUpPopup && (
                <SignUpFormPopup
                    ...
                    onSignUpSuccess={() => {
                        ...
                        navigate("/sell"); // Redirect to sell after signup
            ...
            {showLoginFormPopup && (
                <LoginFormPopup
                    ...
                    onLoginSuccess={() => {
                        ...
                        navigate("/sell"); // Redirect to sell after login
